...
function initializeInteractiveElements() {
    ...
    actionButtons.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            const appointmentInfo = this.closest('.appointment-card').querySelector('.appointment-info h4').textContent;
            
            if (action === 'edit') {
                showNotification(`Editing appointment: ${appointmentInfo}`, 'info');
            } else {
                if (confirm(`Are you sure you want to cancel: ${appointmentInfo}?`)) {
                    showNotification(`Appointment cancelled: ${appointmentInfo}`, 'success');
    ...
    memberActionButtons.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            const memberName = this.closest('.team-member-card').querySelector('.member-info h4').textContent;
